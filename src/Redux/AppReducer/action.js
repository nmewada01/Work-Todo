...
const getTasks = () => (dispatch) => {
  ...
  return axios
    .get("https://desktime-tanner-redux.herokuapp.com/tasks")
    .then((r) => {
...
const getTagsList = () => (dispatch) => {
  ...
  return axios
    .get("https://desktime-tanner-redux.herokuapp.com/tagList")
    .then((r) => {
...
const updateSubtasksList = (id, payload) => (dispatch) => {
  ...
  return axios
    .patch(`https://desktime-tanner-redux.herokuapp.com/tasks/${id}`, payload, {
      headers: {
...
const addTag = (tag) => (dispatch) => {
  ...
  return axios
    .post("https://desktime-tanner-redux.herokuapp.com/tagList", { tag })
    .then((r) => {
...
const createTask = (payload) => (dispatch) => {
  ...
  return axios
    .post("https://desktime-tanner-redux.herokuapp.com/tasks", payload)
    .then((r) => {
